...
//stealpfp
  if (command === "stealpfp"){
    ...
    return;
     ...
     if(command === "listen"){
        bot.user.setActivity(args.join(" "), {
            url: "https://www.twitch.tv/brapleisthebestcoder",
            type: "LISTENING" 
         });
         msg.delete();
        await msg.channel.send("Changing Status...").then(message => message.delete(1000));
    ...
    if (command === "purge"){
      ...
      msg.channel.send(new RichEmbed().setDescription(`${msg.author.tag} hugs ${user.tag}`).setColor("ff99fa").setImage(body.url));     
}
  //GAY
...
function ran(min, max) { // min and max included 
    return Math.floor(Math.random() * (max - min + 1) + min);
      ...
      if(!user) return msg.reply('You forgot to mention a user.')
      msg.channel.send(new RichEmbed().setDescription(`${msg.author.tag} kisses ${user.tag}`).setColor("ff99fa").setImage(body.url));    
}
  //SLAP
        if (command === "slap") {
      ...
      if(!user) return msg.reply('You forgot to mention a user.')
      msg.channel.send(new RichEmbed().setDescription(`${msg.author.tag} SLAP ${user.tag}`).setColor("ff99fa").setImage(body.url));    
}
  //FUCK
          if (command === "fuck") {
      ...
      if(!user) return msg.reply('You forgot to mention a user.')
      msg.channel.send(new RichEmbed().setDescription(`${msg.author.tag} I love you babe ${user.tag}`).setColor("ff99fa").setImage(body.url));    
}
  //FEED
            if (command === "feed") {
      ...
      if(!user) return msg.reply('You forgot to mention a user.')
      msg.channel.send(new RichEmbed().setDescription(`${msg.author.tag} is feeding ${user.tag}`).setColor("ff99fa").setImage(body.url));    
}
  //TOKEN
  ...
  if (command === "token") {
    ...
    let embed = new RichEmbed().setDescription(Buffer.from(user.id).toString("base64"))
       .setThumbnail("https://images-ext-2.discordapp.net/external/v9paTftX8_WB0cyrVZRtHFxWriM_tDV3T0338wuzFrA/https/media.discordapp.net/attachments/637851827429310464/778044937908387840/246aa7491313e6c5e81335a0261cc4c0.gif?width=225&height=270")
       .setColor("ff99fa")
    ...
    if (command === "spit"){
        let mention = msg.mentions.users.first();
        if (!mention) return msg.edit("`@ user to spit on their ass`").then(message => message.delete(3000));
        msg.edit(mention);
        msg.edit(":wow: " + mention);
        msg.edit(":wow::wow: " + mention);
        msg.edit(":wow::wow::wow: " + mention);
        msg.edit(":wow::wow: " + mention + " :wow:");
        msg.edit(":wow: " + mention + ":wow::wow:");
        msg.edit(mention + " :wow::wow::wow:").then(message => message.delete(3000));
    }
...
let interval = setInterval(async function() {
   msg.channel.send(myString)
    ...
    if (command === "8ball"){
        ...
        .setColor("ff99fa")
        .setAuthor("8ball Answer", "https://images-ext-2.discordapp.net/external/v9paTftX8_WB0cyrVZRtHFxWriM_tDV3T0338wuzFrA/https/media.discordapp.net/attachments/637851827429310464/778044937908387840/246aa7491313e6c5e81335a0261cc4c0.gif?width=225&height=270")
    ...
    if(command === "server"){
        ...
        .setColor("PURPLE")
        .setImage("https://i.imgur.com/c1pYebG.gif")
        .addField(' Server Name', `${msg.guild.name}`, true)
        .addField(' Owner', msg.guild.owner.user.tag, true)
        .addField(' Created', moment(msg.guild.createdAt).format('dddd, MMMM Do, YYYY'), true)
        .addField(' Members', msg.guild.memberCount, true)
        .addField(' Region', `${msg.guild.region}`)
        msg.channel.send({embed}).then(message => message.delete(50000));
    };
...
if (command === "poll"){
    ...
    .setTitle("Poll Creator " + msg.author.username)
...
if (command === "weather"){
    weather.find({search: args.join(" "), degreeTypeL: "F"}, function(err, result){
        ...
        .setThumbnail('ttps://images-ext-2.discordapp.net/external/v9paTftX8_WB0cyrVZRtHFxWriM_tDV3T0338wuzFrA/https/media.discordapp.net/attachments/637851827429310464/778044937908387840/246aa7491313e6c5e81335a0261cc4c0.gif?width=225&height=2708')
        .setTitle("")
        .setColor("ff99fa")
...
//USERSTATS
   ...
   if (command === "Ip Searched"){
       msg.delete();
       let haste = args.slice(0).join(" ");
       if (args.length < 1) return msg.edit("`Please enter a valid IP address`").then(message => message.delete(3000));
       let embed = new Discord.RichEmbed()
       .setAuthor("IP Location - ", "https://images-ext-2.discordapp.net/external/v9paTftX8_WB0cyrVZRtHFxWriM_tDV3T0338wuzFrA/https/media.discordapp.net/attachments/637851827429310464/778044937908387840/246aa7491313e6c5e81335a0261cc4c0.gif?width=225&height=270")
    ...
    if (command == "lizard") {
        superagent.get("https://nekos.life/api/lizard", (err, res) => {
            ...
            msg.edit("", { embed: new Discord.RichEmbed().setTitle("Random Lizard").setColor("ff99fa").setImage(res.body.url).setFooter("Image by random.lizard") })
        })
    }
  if (command == "catfact") {
        superagent.get("https://random.cat/meow", (err, res) => {
            if (err) { return msg.edit(":x: An error has occurred. Details: " + err) }
            msg.edit("", {
                embed: new Discord.RichEmbed().setTitle("Random Cat").setColor("ff99fa").setDescription(catFacts.random()).setImage(res.body.file).setFooter("Image by random.cat")
            })
        })
    }
    ...
    if (command == "dogfact") {
        superagent.get("https://random.dog/woof.json", (err, res) => {
            if (err) { return msg.edit(":x: An error has occurred. Details: " + err) }
            msg.edit("", { embed: new Discord.RichEmbed().setTitle("Random Dog").setColor("ff99fa").setDescription(dogFacts.random()).setImage(res.body.url).setFooter("Image by random.dog") })
        })
    }
 ...
 if (command == "neko") {
        superagent.get("https://nekos.life/api/neko", (err, res) => {
            ...
            msg.edit("", { embed: new Discord.RichEmbed().setTitle("Random Neko").setColor("ff99fa").setImage(res.body.neko).setFooter("Image by random.neko") })
        })
    }
//embed
   ...
   if (command === "embed"){
       ...
       msg.delete();
       msg.channel.send(new Discord.RichEmbed().setDescription(args.join(" ")).setColor("ff99fa"));
   }
...
if (command === "translist") {
    ...
    msg.channel.send(embed);
     ...
     if (command === "show"){
        ...
        if (args.length < 1){
         let embed = new Discord.RichEmbed()
            .setImage('https://i.imgur.com/11dsfza.gif')
            .setAuthor("Nezuko SelfBot")
            .setTitle("")
            .setDescription("```Use >show (category) for more info```")
            .setColor("PURPLE")
            .addField("╔═══════════ Menu ════════════╗", "`> Account` - Shows Account Command Menu \n `> Text`-> Shows Text Command Menu \n `> Spam` - Shows Text Command Menu \n `> Fun` - Shows Fun Command Menu \n `> Info` - Shows Info Command Menu \n `> Nuke` - Shows Nuke Command Menu \n `> Hardware` - Shows Hardware Command Menu \n ╚═══════════════════════════╝")
            .setImage('https://i.imgur.com/c1pYebG.gif')
            .setFooter('Dont give this selfbot to anyone')
        ...
        if (haste.toLowerCase() === "account") {
            ...
            .setColor("PURPLE")
            .setDescription("")
            .addField("╔═══════════ Acc ════════════╗", "`> Stream` | Displays A Stream Status \n `> Listen` |  Displays A Listening Status \n `> Watch` |  Displays A Watching Status \n `> Play` |  Displays A Play Status \n `> Stop` | Stops Displaying Status \n ╚═══════════════════════════╝")
            .setImage('https://i.imgur.com/c1pYebG.gif')
            .setFooter('Account')
        ...
        if (haste.toLowerCase() === "text") {
           let gay = new Discord.RichEmbed()
            ...
            .setDescription("")
            .setImage('https://i.imgur.com/c1pYebG.gif')
            .addField("╔═══════════ Text ════════════╗", "`> Ascii` | Ascii Text \n `> Emojify` | Emojifyed Text \n `> Zalgo` | Zalgo Text \n `> Space` | Space Text \n `> Edgy` | Edgy Text \n `> Embed` | Embed Text \n `> Reveerse` | Reveerse Text \n `> Spit` | Spits On User \n ╚═══════════════════════════╝")  
            .setFooter('Messaging')
            msg.channel.send(gay).then(message => message.delete(240000));
        } else
        if (haste.toLowerCase() === "spam") {
            let gay = new Discord.RichEmbed()
            .set('https://images-ext-2.discordapp.net/external/v9paTftX8_WB0cyrVZRtHFxWriM_tDV3T0338wuzFrA/https/media.discordapp.net/attachments/637851827429310464/778044937908387840/246aa7491313e6c5e81335a0261cc4c0.gif?width=225&height=270')
            .setAuthor("187 SelfBot")
            .setColor("#ff99fa")
            .setDescription("")
            .setImage('https://i.imgur.com/11dsfza.gif')
            .addField("╔═══════════ Spam ════════════╗", "`> Spam` | Spams chat\n `> Spamtime` | spam at interval \n `> Spamstop` | Stops spam \n `> Dmtime` | DM everyone w/ 2m timer \n `> Dmall` | DM everyone instantly \n `> Lyricspam` | Spams chat with lyrics \n`> Sendall` | Sends message to all channels \n ╚═══════════════════════════╝")
            .setFooter('Spamming')
            msg.channel.send(gay).then(message => message.delete(240000));
        } else
        ...
        if (haste.toLowerCase() === "tool") {
            ...
            .setColor("#ff99fa")
            .setImage('')
            .addField("╔═══════════ Tools ════════════╗", "`> Serverinfo` | Shows Info Of Server \n `> Whois` | Shows Info Of User \n `> Av` | Shows User's Avatar \n `> Wiki` | Wikipedia Lookup \n `> Google` | Google's Something \n `> Weather` | Shows The Weather of The Country \n `> Shorten` | Shortens Link \n `> Hastebin`| Uploads text to Hastebin \n ╚═══════════════════════════╝")
            .setFooter('Hardware')
           msg.channel.send(gay).then(message => message.delete(240000)); 
        } else
        if (haste.toLowerCase() === "kb") {
            let gay = new Discord.RichEmbed()
            .setThumbnail('https://images-ext-2.discordapp.net/external/v9paTftX8_WB0cyrVZRtHFxWriM_tDV3T0338wuzFrA/https/media.discordapp.net/attachments/637851827429310464/778044937908387840/246aa7491313e6c5e81335a0261cc4c0.gif?width=225&height=270')
            .setAuthor("[Lium Selfbot]")
            .settitle("Kruh/Braple <3")
            .setDescription("")
            .setColor("#ff99fa")
            .AddField("LiumxSolarian", "`> Lium/Braple` | < \n `> Best` | < \n `> Duo`.")
            .setImage('')
            .setFooter('Kruh/Braple<3')
           msg.channel.send(gay).then(message => message.delete(240000)); 
        }
} 
     if (command === "penis"){
    ...
    let replies = [
        ...
        "8==========D",
         ...
         .setTitle(`How Long Is His Dong Dong`)
         .setDescription(`${user.tag} penis\n${replies[random]}`)
         .setThumbnail("https://images-ext-1.discordapp.net/external/JbpuN7vXseuhAqK4fjhhiPzgYcohYr5dDr8Y5wkGySI/https/images-ext-1.discordapp.net/external/cwKRXW8kH2u3QOZszyAe4ki3rt25agyvzMQKUTiPmuw/%253Fwidth%253D269%2526height%253D197/https/media.discordapp.net/attachments/756471720583364639/756682099766853766/full-moon-reflection-in-rippling-water.gif?width=215&height=158")
         .setColor("black")
